                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="flex flex-col items-center justify-center py-24">
                        ...
                        >
                            ...
                            <h1 className="text-3xl font-bold text-white font-casino mb-4">Slots Coming Soon</h1>
                            <p className="text-gray-300 mb-8">
                                Our development team is working hard to bring you exciting Slot machines with big jackpots.
                                Check back soon to spin the reels and win big!
                            </p>
                            <Link
                                to="/blackjack"
